    ...
    <div className=" bg-slate-400 xl:place-content-center px-10 py-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3  min-h-screen">
      ...
      <div className="bg-white rounded-2xl shadow-xl  overflow-hidden group">
        ...
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          <div className="flex relative -top-16 justify-between items-end">
            ...
            <div className="h-24  w-24 bg-blue-200 rounded-full shadow-lg group-hover:-translate-y-2.5 transition" />
            <div className="flex flex-col items-center">
          ...
          <div className="relative  flex flex-col items-center -mt-10 -mb-5">
            <span className="text-lg font-medium">Toney Molloy</span>
      ...
      <div className="bg-white p-10 rounded-2xl shadow-xl lg:col-span-2 xl:col-span-1">
        ...
        <div className="flex flex-col">
          ...
          <span className="font-sm text-gray-500">Chair</span>
          <div className="mt-3 mb-5 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-5">
              <button className="  bg-blue-200 rounded-lg flex justify-center items-center aspect-square w-8 text-xl color-gray-500">
                -
              </button>
              <span>1</span>
              <button className="  bg-blue-200 rounded-lg flex justify-center items-center aspect-square w-8 text-xl color-gray-500">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="bg-blue-500 py-2 px-8 text-center text-white rounded-lg text-xs">
              Add to cart
            </button>
          </div>
        </div>
